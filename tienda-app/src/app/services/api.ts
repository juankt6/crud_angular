...
export class ApiService {
  ...
  login(datos: LoginRequest): Observable<any> { return this.http.post(`${this.apiUrl}/Auth/login`, datos); }
  registrar(datos: LoginRequest): Observable<any> { return this.http.post(`${this.apiUrl}/Auth/registrar`, datos); }
